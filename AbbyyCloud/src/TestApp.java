...
public class TestApp {
	...
	/**
	 * @param args
	 * The filesArray is a series of files that need to be recognised
	 * The last string in filesArray specifies the output format
	 */
	public static void main(String[] args) {
		String[] filesArray={"D:/ws/git/ai_machine_learning/AbbyyCloud/input/workingimage050.png",
				"D:/ws/git/ai_machine_learning/AbbyyCloud/output/result.txt"};
...
//		}
		...
		Vector<String> argList = new Vector<String>(Arrays.asList(filesArray));
